...
class RedisKey
{
    ...
    //获首页缓存key
    public static function getIndexDataKey($babyagetype = 0)
    {
        return 'index_data_' . $babyagetype;
    }

    public static function getCategoryTagsKey()
    {
        return 'category_tags';
    }

    public static function getOnlineListKey($minAge, $maxAge, $page, $len)
    {
        return 'online_list_' . $minAge . '_' . $maxAge . '_' . $page . '_' . $len;
    }
}