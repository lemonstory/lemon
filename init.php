...
if (DIRECTORY_SEPARATOR == '/'){
    define("MANAGE_ROOT", dirname(SERVER_ROOT)."/manage.tutuim.com/");
} else {
    define("MANAGE_ROOT", dirname(dirname(dirname(SERVER_ROOT)))."/com.tutuim.manage/src/trunk/");
}
...
include dirname(__FILE__)."/config/redisconf.php";
